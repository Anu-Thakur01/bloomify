...
<style>
    ...
    .product-card-spacious:hover .product-img-placeholder img {
                        ...
                        <div class="product-price-spacious">
                            ...
                            <?php if ($discount > 0): ?>
                                <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
                                    ...
                                    <span style="color: #dc2626; font-weight: 800; font-size: 1.25rem;">
                            ...
                            <?php else: ?>
                                <span style="color: #2d6a4f; font-weight: 800; font-size: 1.25rem;">
                                    Rs. <?php echo number_format($original_price, 2); ?>
                                </span>
                            <?php endif; ?>
                        </div>
