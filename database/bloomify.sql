...
-- version 5.2.1
-- Host: 127.0.0.1
-- Generation Time: Sep 17, 2026 at 04:30 PM
...
(14, 'Perennial Aquatic', '', 'category_1789650140_701.jpeg', '2026-09-17 13:02:20');
...
CREATE TABLE `products` (
  ...
  `discount_percentage` int(11) DEFAULT 0 CHECK (`discount_percentage` >= 0 and `discount_percentage` <= 100),
...
INSERT INTO `products` (`id`, `category_id`, `name`, `description`, `price`, `discount_percentage`, `stock`, `stock_quantity`, `image`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, 'Blushing Devotion', 'Premium pink roses bouquet', 450.00, 0, 125, 125, 'blushing-devotion.jpg', 'active', '2026-09-13 05:11:14', '2026-09-17 12:25:25'),
(2, 2, 'Cupids Confetti', '25 Mixed Carnations arrangement', 450.00, 0, 88, 88, 'cupids-confetti.jpg', 'active', '2026-09-13 05:11:14', '2026-09-17 12:25:13'),
(3, 1, 'Crimson Romance', 'Premium red roses arranged elegantly to express love and passion.', 600.00, 0, 100, 100, 'flower_1789482162_556.jpg', 'active', '2026-09-15 13:44:13', '2026-09-17 12:25:01'),
(4, 1, 'Golden Rose Delight', 'Fresh yellow roses representing friendship, happiness, and warmth.', 350.00, 0, 200, 200, 'flower_1789480037_565.jpg', 'active', '2026-09-15 13:47:17', '2026-09-17 12:24:44'),
(6, 1, 'Blushing Devotion', 'A graceful bouquet of soft pink roses symbolizing affection and appreciation.', 350.00, 0, 250, 250, 'flower_1789480289_184.webp', 'active', '2026-09-15 13:51:29', '2026-09-17 12:24:34'),
(7, 4, 'Spring Elegance', 'Fresh pink tulips arranged in a graceful and elegant bouquet.', 450.00, 0, 200, 200, 'flower_1789480324_728.webp', 'active', '2026-09-15 13:52:04', '2026-09-17 12:24:18'),
(8, 4, 'Tulip Bliss', 'Beautiful mixed-color tulips creating a cheerful and refreshing arrangement.', 450.00, 0, 300, 300, 'flower_1789480580_102.jpeg', 'active', '2026-09-15 13:56:20', '2026-09-17 12:24:04'),
(10, 4, 'Royal Tulips', 'Premium red and white tulips arranged for a sophisticated floral gift.', 350.00, 0, 100, 100, 'flower_1789480631_161.jpg', 'active', '2026-09-15 13:57:11', '2026-09-17 12:23:52'),
(11, 5, 'Golden Sunshine', 'A vibrant sunflower bouquet perfect for birthdays and celebrations.', 450.00, 0, 1900, 1900, 'flower_1789480978_906.webp', 'active', '2026-09-15 14:02:58', '2026-09-17 12:23:37'),
(12, 5, 'Sunshine Garden', 'Fresh sunflowers combined with delicate greenery for a natural look.', 500.00, 0, 2100, 2100, 'flower_1789481088_768.jpeg', 'active', '2026-09-15 14:04:48', '2026-09-17 12:23:22'),
(14, 8, 'Pure Lily', 'Elegant white lilies arranged in a clean and graceful bouquet.', 570.00, 0, 1900, 1900, 'flower_1789481316_913.webp', 'active', '2026-09-15 14:08:36', '2026-09-17 12:23:00'),
(15, 8, 'Lily Grace', 'Fresh pink lilies beautifully arranged for an elegant floral gift.', 300.00, 0, 100, 100, 'flower_1789481356_794.webp', 'active', '2026-09-15 14:09:16', '2026-09-16 12:30:40'),
(17, 8, 'Royal Lily', 'Premium lilies combined with fresh greenery for a luxurious appearance.', 350.00, 0, 250, 250, 'flower_1789481412_225.jpeg', 'active', '2026-09-15 14:10:12', '2026-09-17 12:22:36'),
(18, 10, 'Purple Elegance', 'Beautiful purple orchids arranged in a luxurious floral display.', 450.00, 10, 200, 200, 'flower_1789481737_136.webp', 'active', '2026-09-15 14:15:37', '2026-09-17 12:21:25'),
(20, 10, 'Orchid Charm', 'Fresh orchids arranged beautifully to create a sophisticated gift.', 340.00, 0, 100, 100, 'flower_1789481889_120.jpeg', 'active', '2026-09-15 14:18:09', '2026-09-16 12:30:40'),
(22, 3, 'Evergreen', 'Be happy and Make Happy', 500.00, 5, 150, 150, 'flower_1789650094_790.jpeg', 'active', '2026-09-16 14:53:39', '2026-09-17 13:34:21'),
(23, 14, 'Lotus', 'Gracefull', 499.00, 10, 100, 100, 'flower_1789650232_107.jpeg', 'active', '2026-09-17 13:03:52', '2026-09-17 13:35:34');
...
(31, 3, 'ORD-20260917-8259AC', 340.00, 'cod', 'pending', NULL, 'pending', 'John', '9800000011', 'New Road', 0, '2026-09-17 11:32:56', '2026-09-17 11:32:56'),
(32, 3, 'ORD-20260917-5B7EC9', 340.00, 'esewa', 'pending', NULL, 'pending', 'John', '9800000011', 'New Road', 0, '2026-09-17 13:44:53', '2026-09-17 13:44:53'),
(33, 3, 'ORD-20260917-82ED7F', 815.00, 'esewa', 'pending', NULL, 'pending', 'John', '9800000011', 'New Road', 0, '2026-09-17 13:45:44', '2026-09-17 13:45:44'),
(34, 3, 'ORD-20260917-624962', 450.00, 'esewa', 'success', '000H4NO', 'processing', 'John', '9800000011', 'New Road', 0, '2026-09-17 14:02:14', '2026-09-17 14:02:46');
...
(2, 2, 3, 4, 'Thank you for the fast delivery', NULL, 'approved', '2026-09-17 14:03:19');
...
-- --------------------------------------------------------
ALTER TABLE `cart` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
ALTER TABLE `categories` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
ALTER TABLE `orders` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
ALTER TABLE `order_items` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
ALTER TABLE `products` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
ALTER TABLE `wishlist` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
