...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // AUTO-COMPLETE: Set both payment and order status to completed
    $sql = "UPDATE orders SET payment_status = 'completed', status = 'completed', transaction_id = ? WHERE id = ?";
...
<body>
    <div class="esewa-container">
        ...
        <div class="demo-note">This is a dummy eSewa login for Bloomify demonstration.</div>
    </div>
</body>
</html>