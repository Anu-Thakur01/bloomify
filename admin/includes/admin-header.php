...
<header class="admin-header">
    <div class="admin-header-content">
        ...
        <nav class="admin-nav">
            <a href="<?php echo SITE_URL; ?>/admin/index.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'index.php' ? 'active' : ''; ?>">Dashboard</a>
            ...
            <a href="<?php echo SITE_URL; ?>/admin/products.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'products.php' ? 'active' : ''; ?>">Products</a>
            <a href="<?php echo SITE_URL; ?>/admin/categories.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'categories.php' ? 'active' : ''; ?>">Categories</a>
            
            <!-- ✅ ADDED REVIEWS LINK HERE -->
            <a href="<?php echo SITE_URL; ?>/admin/reviews.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'reviews.php' ? 'active' : ''; ?>">Reviews</a>
            ...
            <a href="<?php echo SITE_URL; ?>/logout.php" class="admin-logout">Logout</a>
        </nav>
    </div>
</header>
